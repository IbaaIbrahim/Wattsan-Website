...
const BESTSELLERS: BestsellerItem[] = [
	...
	{
		id: 'b5',
		code: 'WATTSAN 1610 ST',
		category: 'Medium Format Laser Cutter',
		status: 'in_stock',
		priceExclVat: '$7,200',
		preOrderPrice: '$7,800',
		rating: '4.9',
...
export const BestsellersSlider: FC = () => {
	...
	const handleAddToCart = async (e: React.MouseEvent, item: BestsellerItem) => {
		e.stopPropagation()
		e.preventDefault()
		...
		<section className={styles.section}>
			<div className={styles.container}>
				<div className={styles.header}>
					<h2 className={styles.title}>Hits of Sales</h2>
					<Button
						href='/configurator'
						view='bordered'
						size='m'
								...
								<div className={styles.content}>
									...
									<div className={styles.pricesGrid}>
										...
										<div className={styles.priceCol}>
											...
											<div className={styles.preOrderPriceWrap}>
